...
public @interface OrderItemProductRelationConnectionSubscriptionArguments {
  ...
  StringExpression1 productRef() default @StringExpression1;
  ...
  OrderItemProductRelationOrderBy1 orderBy() default @OrderItemProductRelationOrderBy1;
  ...
  OrderItemProductRelationExpression1[] exs() default {};
