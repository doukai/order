...
public @interface OrderItemExpression1 {
  ...
  OrderItemProductRelationExpression2 orderItemProductRelation(
      ) default @OrderItemProductRelationExpression2;

  boolean not() default false;

  Conditional cond() default Conditional.AND;

  OrderItemExpression2[] exs() default {};
