...
public class UserPhoneNumbersRelationListMutationArguments implements MetaInput {
  private String id;
  ...
  private Collection<UserPhoneNumbersRelationInput> list;
  ...
  public Collection<UserPhoneNumbersRelationInput> getList() {
    return this.list;
  }

  public void setList(Collection<UserPhoneNumbersRelationInput> list) {
    this.list = list;
  }
