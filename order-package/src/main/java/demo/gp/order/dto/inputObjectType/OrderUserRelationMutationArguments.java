...
public class OrderUserRelationMutationArguments implements MetaInput {
  private String id;
  ...
  private OrderUserRelationInput input;
  ...
  public OrderUserRelationInput getInput() {
    return this.input;
  }

  public void setInput(OrderUserRelationInput input) {
    this.input = input;
  }
