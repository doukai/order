...
public @interface UserPhoneNumbersRelationExpression1 {
  ...
  StringExpression2 phoneNumbersRef() default @StringExpression2;
  ...
  UserPhoneNumbersRelationExpression2[] exs() default {};
