...
import io.graphoenix.core.dto.annotation.FloatExpression1;
...
public @interface ProductConnectionSubscriptionArguments {
  StringExpression1 id() default @StringExpression1;

  StringExpression1 name() default @StringExpression1;

  FloatExpression1 price() default @FloatExpression1;
  ...
  ProductOrderBy1 orderBy() default @ProductOrderBy1;
  ...
  ProductExpression1[] exs() default {};
