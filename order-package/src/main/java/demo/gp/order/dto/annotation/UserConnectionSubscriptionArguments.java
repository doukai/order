...
public @interface UserConnectionSubscriptionArguments {
  ...
  StringExpression1 phoneNumbers() default @StringExpression1;

  UserTypeExpression1 userType() default @UserTypeExpression1;

  OrderExpression1 orders() default @OrderExpression1;
